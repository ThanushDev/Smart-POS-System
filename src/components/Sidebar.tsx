...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    // 404 එනවා නම් මෙතන 'path' එක App.tsx එකේ තියෙන නමටම වෙනස් කරන්න
  ...
  return (
    <aside className="w-72 bg-white h-screen flex flex-col border-r border-slate-100 shadow-sm z-50 sticky top-0">
      <div className="p-10">
        <div className="bg-indigo-600 text-white w-12 h-12 rounded-2xl flex items-center justify-center shadow-lg mb-4 rotate-3">
          <Terminal size={24} />
        </div>
