            ...
            <div className="bg-white w-full max-w-md rounded-[3.5rem] p-10 relative shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <input 
                    type="text" 
                    className="w-full p-4 bg-slate-50 rounded-2xl outline-none font-bold border border-transparent focus:border-indigo-100 focus:bg-white transition-all" 
                    value={formData.name} 
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <label className="text-[10px] font-black text-slate-400 uppercase ml-2">Unit Price</label>
                    <input 
                      type="number" 
                      step="any"
                      className="w-full p-4 bg-slate-50 rounded-2xl outline-none font-bold border border-transparent focus:border-indigo-100 focus:bg-white" 
                ...
                <div className="p-4 bg-emerald-50 rounded-2xl border border-emerald-100">
                  <label className="text-[10px] font-black text-emerald-600 block uppercase mb-1">Discount Percentage (%)</label>
                  <input 
                    type="number" 
                    step="any"
                    className="w-full bg-transparent font-black text-emerald-700 text-xl outline-none" 
                ...
                <button type="submit" className="w-full py-5 bg-indigo-600 text-white rounded-[2rem] font-black uppercase text-sm shadow-xl shadow-indigo-100 mt-4 hover:bg-indigo-700 active:scale-95 transition-all">
