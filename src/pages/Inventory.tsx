...
const Inventory = () => {
  ...
  // FIXED: Barcode unique generation delay fix
  const handlePrint = useReactToPrint({
    content: () => printRef.current,
    onBeforeGetContent: () => {
      return new Promise((resolve) => {
        setTimeout(() => resolve(), 1200); // Unique barcode eka generate wenna 1.2s delay ekak denawa
      });
    },
  ...
  return (
    <div className="flex h-screen bg-slate-50 italic font-sans">
      ...
      <main className="flex-1 p-8 overflow-y-auto">
        ...
        {/* FIXED: HIDDEN PRINT CONTAINER (OFF-SCREEN INSTEAD OF OPACITY-0) */}
        ...
        {/* Modal (Keep your original modal) */}
        {showModal && (
