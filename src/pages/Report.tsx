    ...
    <div className="flex h-screen bg-slate-50 overflow-hidden font-sans">
      ...
      <main className="flex-1 p-4 md:p-8 overflow-y-auto pt-20 md:pt-8">
        <header className="mb-8 md:mb-10">
          <h1 className="text-2xl md:text-3xl font-black italic uppercase">Sales <span className="text-indigo-600">Analytics</span></h1>
          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Business Growth Metrics</p>
        </header>

        <div className="bg-white p-6 md:p-10 rounded-[2.5rem] md:rounded-[3.5rem] shadow-sm border border-slate-100 h-[320px] md:h-[500px]">
